  ...
  const blogPosts: { [key: string]: { title: string; date: string; content: string } } = {
    '1': {
      ...
      content: `
        ...
        <p>Ultimately, the choice between lab-grown and mined diamonds is a personal one. Both are beautiful, durable, and valuable. At Facet & Co., we are proud to offer ethically-sourced lab-grown diamonds, providing a responsible and brilliant choice for your jewelry.</p>
      `,
    },
    '2': {
    ...
    '3': {
      ...
      date: 'June 01, 2025',
      content: `
        <p>In an era where conscious consumerism is paramount, the demand for ethically and sustainably produced goods has extended to the luxury market, including fine jewelry. At Facet & Co., we are at the forefront of this movement, committed to offering beautiful jewelry that aligns with your values.</p>
        ...
        <p>Our dedication to sustainable luxury is an ongoing journey. We continuously research and implement new practices to minimize our impact and contribute positively to the industry and the planet. When you choose Facet & Co., you're not just buying a piece of jewelry; you're investing in a future where luxury and responsibility go hand in hand.</p>
      `,
    },
  };
