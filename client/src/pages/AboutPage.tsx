  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-ivory to-champagne py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl md:text-5xl font-light text-graphite text-center mb-16 font-primary tracking-tight">
          About Us
        </h1>
        ...
        <div className="space-y-20">
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-sm border border-champagne/30">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="order-1 md:order-2">
                <h2 className="text-3xl md:text-4xl font-normal text-graphite mb-6 text-center md:text-left font-primary">
                  Our Mission
                </h2>
                <p className="text-lg text-graphite/90 leading-relaxed font-secondary text-center md:text-left">
